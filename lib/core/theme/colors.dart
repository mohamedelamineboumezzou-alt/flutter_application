...
class AppColors {
  ...
  static const Color redError = Color(0xffcc0000);
  static const Color greenSuccess = Color(0xff198754);
  static const Color yellowWarning = Color(0xffFF9800);

  //Grays
  static const Color deepGray = Color(0xff6B7280);
